...
namespace Kodimax
{
    ...
    public class Program 
    {
        ...
        public static void Main()
        {
			...
			clientes.Add(new People("David", "Mendoza", "davmen@gmail.com", "87654321", 'M', "19/06/01", "david", "9182"));
        	clientes.Add(new People("Carmen", "Morales", "carmor@gmail.com", "78494999", 'F', "31/09/99", "carmen", "0192"));
        	clientes.Add(new People("Eduardo", "Guevara", "edugue@gmail.com", "83839396", 'M', "12/03/99", "eduardo", "8374"));
        	//Lista de empledos
        	List<Employee> empleados = new List<Employee>();
			empleados.Add(new Employee(1, "Angel", "Servellon", "angser@gmail.com", "12345678", 'M', "19/06/01", "angel", "1234"));
        	empleados.Add(new Employee(2, "Kevin", "Gutierrez", "kevgut@gmail.com", "91234567", 'M', "14/01/01", "kevin", "5678"));
        	empleados.Add(new Employee(3, "Jennifer", "Beltran", "jenbel@gmail.com", "89123456", 'F', "23/10/01", "jenny", "9123"));
        	//Lista de peliculas
        	...
        	do{
        		...
        		if(pass== 0){
        			if(opt== 1){
        				...
        				if(regis== 1) p.Register(clientes, empleados);
        			}
        			if(opt== 2){
